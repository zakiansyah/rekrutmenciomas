...
<section class="content-header">
    ...
    <div class="row mb-2">
        ...
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Laporan Pelamar</li>
        </ol>
        </div>
    </div>
    </div><!-- /.container-fluid -->
...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="card">
            ...
            <h3 class="card-title">Laporan Pelamar</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
            <form method="POST" action="">
                        ...
                        <div class="text-left">
                            ...
                            <a href="laporan_print.php?mulai=<?php echo $date1; ?>&sampai=<?php echo $date2; ?>" target="blank" class="btn btn-outline-info"><i class="fas fa-print"></i> Cetak</a>
                        </div>
                    </form>
                    <br>
