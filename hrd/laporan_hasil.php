...
if (isset($_POST['submit'])) {
    ...
    if (!empty($date1) && !empty($date2)) {
        ...
        $query_tampil = mysqli_query($koneksi, "SELECT users.*, pelamars.*, penilaians.*
                        ...
                        WHERE penilaians.hasil='Lulus'
                        AND penilaians.tgl_nilai BETWEEN '$date1' and '$date2' ORDER BY tgl_nilai ASC");
    } else {
...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Laporan Hasil Penerimaan</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Laporan Hasil Penerimaan</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Laporan Hasil Penerimaan</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form method="POST" action="">
                            ...
                            <div class="text-left">
                                ...
                                <a href="laporan_print4.php?mulai=<?php echo $date1; ?>&sampai=<?php echo $date2; ?>" target="blank" class="btn btn-outline-info"><i class="fas fa-print"></i> Cetak</a>
                            </div>
                        </form>
                        <br>
